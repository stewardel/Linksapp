 ...
 <body>
    <div id="options_div">
       <div id="title_div">BOOKMARK OPTIONS
           <a href="../mobile/home.php" id="back_home">❌</a>
       </div>
        ...
        <a href="mailto:?subject=Sharing-a-Link&body=<?php echo $url."       Sent from http://linkper.cc"; ?>" target="_blank" id="email_share"><img src="../icons/mailsymbol.png" id="email_img"></a>
        ...
        <a href="https://t.me/share/url?url=<?php echo $url; ?>" target="_blank" id="mail_share"><img src="../icons/telegram.jpg" id="email_img"></a>
        ...
        <a href="../mobile/deleteUrl.php?u=<?php echo $url; ?>" id="mail_share"><img src="../icons/deleteicon.png" id="email_img"></a>
        <a href="https://t.me/share/url?url=<?php echo $url; ?>" target="_blank" id="mail_share"><img src="../icons/share.png" id="email_img"></a>
